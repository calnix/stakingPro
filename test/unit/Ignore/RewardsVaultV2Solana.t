...
abstract contract StateT11_Distribution1CreatedAsRemote_RewardsVaultV2 is StateT6_User2StakeAssetsToVault1 {
    ...
    uint32 public dstEidSolana = 30168;   // solana eid
    ...
    function setUp() public virtual override  {
        ...
        vm.startPrank(owner);            
            rewardsVaultV2.setPeer(dstEidSolana, bytes32(uint256(uint160(address(1)))));
        vm.stopPrank();
...
contract StateT11_Distribution1CreatedAsRemote_RewardsVaultV2Test is StateT11_Distribution1CreatedAsRemote_RewardsVaultV2 {
    ...
    function test_Distribution1CreatedOnRewardsVaultV2() public {
        ...
        assertEq(d1.dstEid, dstEidSolana);
...
abstract contract StateT11_Distribution1DepositedOnSolanaVault is StateT11_Distribution1CreatedAsRemote_RewardsVaultV2 {
    using stdStorage for StdStorage;
    ...
    function setUp() public virtual override {
        ...
        // user sets address on rewards vaultV2
        vm.startPrank(user2);
            rewardsVaultV2.setReceiver(user2, bytes32(uint256(uint160(user2))));
        vm.stopPrank();
    }
}

contract StateT11_Distribution1DepositedOnSolanaVaultTest is StateT11_Distribution1DepositedOnSolanaVault {

    function test_Distribution1Deposited_Solana() public {
        RewardsVaultV1.Distribution memory d1 = getDistributionFromRewardsVaultV2(1);
        assertEq(d1.totalDeposited, totalRequired);
    }

    // test user can claim if remote evm token rewards
    function test_User2CanClaimRewards_Solana() public {
